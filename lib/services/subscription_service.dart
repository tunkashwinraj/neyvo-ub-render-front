...
class SubscriptionService {
  static Future<Map<String, String>> _authHeaders() async {
    // SpeariaApi already centralizes auth headers in most calls;
    // here we only need Authorization & ngrok header.
    return <String, String>{
      'Accept': 'application/json',
      if (SpeariaApi.sessionToken != null)
        'Authorization': 'Bearer ${SpeariaApi.sessionToken}',
      if (SpeariaApi.baseUrl.contains('ngrok'))
  ...
  static Future<SubscriptionPlan> getCurrentPlan() async {
    final uri = Uri.parse(
        '${SpeariaApi.baseUrl}/api/billing/subscription');
  ...
  static Future<void> upgradePlan(String tier) async {
    final uri = Uri.parse(
        '${SpeariaApi.baseUrl}/api/billing/subscription/upgrade');
  ...
  static Future<void> cancelPlan() async {
    final uri = Uri.parse(
        '${SpeariaApi.baseUrl}/api/billing/subscription/cancel');
